import {
    Modal, ModalContent, ModalOverlay, ModalHeader, ModalCloseButton, ModalBody, Text, Divider, ModalFooter, Button, Flex
...
export default function TeamModal(props: any){
    const { isOpen, onOpen, onClose, name, memberData, description} = props;
    const { user } = useAuth();
    ...
    return(
        <>
          ...
          {memberData
            .map((member: any) => console.log(member.name))}
        </Flex>
                    </ModalBody>
                    <ModalFooter>
